const en = {
	...
	publicApiQuotaExceeded: 'Public API daily quota exceeded',
	publicCreateCountInvalid: 'Count must be an integer between 1 and 50',
	publicExpiryDaysInvalid: 'Expiry days only supports 1, 5, 7, 14, 30',
