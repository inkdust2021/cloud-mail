...
const requirePerms = [
	...
	'/setting/set',
	'/setting/query',
	'/setting/queryPublicApiToken',
	'/setting/refreshPublicApiToken',
	'/user/delete',
	'/user/setPwd',
	'/user/setStatus',
	'/user/setType',
...
const premKey = {
	...
	'setting:query': ['/setting/query', '/setting/queryPublicApiToken'],
	'setting:set': ['/setting/set', '/setting/setBackground','/setting/deleteBackground', '/setting/refreshPublicApiToken'],
...
app.use('*', async (c, next) => {
	...
	if (permIndex > -1) {
		...
		if (userPermIndex === -1 && authInfo.user.email !== c.env.admin && Number(authInfo.user.type) !== 0) {
