const en = {
    ...
    apiKeyEmpty: 'No API Key yet, please generate one first',
    apiKeyDesc: 'Used for public API calls. Regenerating it invalidates the old key immediately',
    regenerateApiKeyConfirm: 'Regenerating will immediately invalidate the old API Key. Continue?',
    regenerateApiKeySuccess: 'API Key regenerated successfully',
    oss: 'Object Storage',
    osDomain: 'Domain',
    ...
    delAccountsConfirm: 'Confirm deleting {msg} selected addresses?',
    batchDeleteSuccessMsg: 'Deleted {msg} addresses successfully',
    batchDeleteResultMsg: 'Delete completed: {success} succeeded, {failed} failed',
    ...
    addTempSuccessMsg: 'Temporary mailbox created successfully',
