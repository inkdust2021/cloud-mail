const zh = {
    ...
    apiKeyEmpty: '暂无 API Key，请先生成',
    apiKeyDesc: '用于调用公开 API，重新生成后旧 Key 会立即失效',
    regenerateApiKeyConfirm: '重新生成后旧 API Key 会立即失效，确认继续吗？',
    regenerateApiKeySuccess: 'API Key 已重新生成',
    oss: '对象存储',
    osDomain: '访问域名',
    ...
    delAccountsConfirm: '确认删除选中的 {msg} 个邮箱吗？',
    batchDeleteSuccessMsg: '成功删除 {msg} 个邮箱',
    batchDeleteResultMsg: '删除完成：成功 {success} 个，失败 {failed} 个',
    delSuccessMsg: '删除成功',
